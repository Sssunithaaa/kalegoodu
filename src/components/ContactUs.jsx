  ...
  return (
    <div className="flex flex-col w-full items-center p-4">
      ...
      <div className="flex flex-col md:flex-row md:flex-wrap items-center gap-y-5 md:gap-x-8 w-full mx-auto justify-center">
        ...
        <motion.div variants={fadeIn("up","",0.2,1)} className="flex flex-col  md:max-w-[250px] w-full items-center bg-gray-100 p-6 rounded-lg shadow-lg">
        ...
        {/* Email Section */}
        <motion.div variants={fadeIn("up","",0.4,1)} className="flex flex-col  md:max-w-[250px] w-full items-center bg-gray-100 p-6 rounded-lg shadow-lg">
        ...
        {/* Address Section */}
        <motion.div variants={fadeIn("up","",0.6,1)} className="flex flex-col  md:max-w-[250px] w-full items-center bg-gray-100 p-6 rounded-lg shadow-lg">
