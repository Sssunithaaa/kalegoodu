...
const ContactUs = () => {
  return (
    <div className="flex flex-col w-full items-center p-4">
      ...
      <div className="flex flex-col w-full md:flex-row justify-center space-x-8">
        {/* Phone/WhatsApp Section */}
        <div className="flex flex-col md:w-[20%] items-center bg-gray-100 p-6 rounded-lg shadow-lg">
