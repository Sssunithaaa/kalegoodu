...
import { img1, img11, img2, img3 } from '../assets/images'; // Example images
...
const Products = () => {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      let fetchedProducts = [ // Example static data
        { id: 1, name: 'Product 1', date: new Date(2023, 5, 10), price: 100, img: img1 },
        { id: 2, name: 'Product 2', date: new Date(2023, 6, 15), price: 200, img: img2 },
        { id: 3, name: 'Product 3', date: new Date(2023, 4, 20), price: 50, img: img3 }
      ];
