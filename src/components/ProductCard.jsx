...
<Card
  className={`w-full my-2 py-1 mx-auto lg:mx-2 shadow-lg ${productMode ? 'max-w-[11rem] xs:max-w-[10rem] ys:max-w-[11rem] zs:max-w-[12rem]' : 'max-w-[20rem]'}  md:max-w-[14rem] ws:max-w-[17rem] lg:max-w-[19rem]'`}
>      <CardHeader
